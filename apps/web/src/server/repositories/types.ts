...
import type { Application, ChatMessage, Invitation, Project, UserProfile, WorkspaceAiMessage, WorkspaceExpense, WorkspaceMembership, WorkspaceResource } from "@project-matchmaker/shared";
